...
function SMChangeStateMario(newState)
{
	...
	switch(state)
	{
		...
		case 14:
			...
			break;
		//case 15:
		//	nextState = EnterAttackMario(sprMarioNormalUp_initial_Air, sprMarioNormalUp_final_Air); //up normal
		//	break;
		case 16:
			nextState = EnterAttackMario(sprMarioSpecialAttackUp_Air, sprMarioSpecialAttackUp_Air); //up special
			break;
		case 17:
